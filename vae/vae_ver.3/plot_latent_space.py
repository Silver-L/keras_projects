...
def plot_latent_space():
    ...
    parser.add_argument('--model', '-i1', default='F:/experiment_result/vae_2/encoder_model/encoder_200.hdf5',
                        help='model')
    parser.add_argument('--train_data_list', '-i2', default='F:/data_info/VAE/train_data_list.txt',
                        help='name list')
