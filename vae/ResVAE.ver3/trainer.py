...
def main():
    ...
    parser.add_argument('--outdir', '-i3', default='F:/experiment_result/vae_32', help='outdir')

    args = parser.parse_args()

    # check folder
    # if not (os.path.exists(args.outdir + '/vae_model')):
    #     os.makedirs(args.outdir + '/vae_model')
    ...
    model.summary()
    model.compile(optimizer=Adam(lr=8e-5, beta_1=0.5, beta_2=0.9), loss=[zero_loss])
    ...
    for epoch_index in range(epoch):
        ...
        # model.save(os.path.join(args.outdir + '/vae_model/', 'vae_{}.hdf5'.format(epoch_index + 1)))
